...
/*   Updated: 2019/03/15 15:22:25 by nvienot          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	mlx_string_put(win->mlx_ptr, win->win_ptr, 10, 65, \
		GREY, "Move : Arrow keys");
	mlx_string_put(win->mlx_ptr, win->win_ptr, 10, 85, GREY, "Zoom : Scroll");
	...
	mlx_string_put(win->mlx_ptr, win->win_ptr, 10, 245, GREY, "Reset : R");
	mlx_string_put(win->mlx_ptr, win->win_ptr, 10, 265, GREY, "Quit : Esc");
}
...
void		ft_print_menu(t_win *w)
{
	...
	ft_print_menu_1(w);
	mlx_string_put(w->mlx_ptr, w->win_ptr, 10, 45, \
